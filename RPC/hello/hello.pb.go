...
var file_hello_hello_proto_rawDesc = []byte{
	...
	0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x83, 0x01, 0x0a, 0x07, 0x47, 0x72, 0x65,
	...
	0x72, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x40, 0x0a, 0x0e,
	0x53, 0x61, 0x79, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x12, 0x15,
	...
	0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x30, 0x01, 0x42, 0x08,
...
var file_hello_hello_proto_depIdxs = []int32{
	...
	0, // 1: greeter.Greeter.SayStreamHello:input_type -> greeter.HelloRequest
	1, // 2: greeter.Greeter.SayHello:output_type -> greeter.HelloReply
	1, // 3: greeter.Greeter.SayStreamHello:output_type -> greeter.HelloReply
...
func (c *greeterClient) SayStreamHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (Greeter_SayStreamHelloClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Greeter_serviceDesc.Streams[0], "/greeter.Greeter/SayStreamHello", opts...)
	if err != nil {
		return nil, err
	}
...
func (*UnimplementedGreeterServer) SayStreamHello(*HelloRequest, Greeter_SayStreamHelloServer) error {
